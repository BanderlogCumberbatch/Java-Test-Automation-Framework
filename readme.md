...
1. **Секция browser**:
   ...
   1. implicit_wait: время неявного ожидания элементов (в секундах)
   1. window_size: размер окна браузера (формат ширина x высота)
...
by: "ТИП_ЛОКАТОРА"  *# Один из: ID, XPATH, CSS, NAME, CLASS_NAME, TAG_NAME*
...
1. **Динамические значения**:
   ...
   1. Подстановка значений окружения:${environments.dev.base_url}
